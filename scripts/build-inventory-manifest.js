...
const fieldAliases = {
  ...
  updatedAt: ['updatedAt', 'updated_at', 'updateTime', 'update_time', 'updatedTime', 'updated_time', 'fetchedAt', 'fetched_at', 'syncedAt', 'synced_at', 'priceUpdatedAt', 'price_updated_at', 'priceUpdateTime', 'price_update_time', 'rateUpdatedAt', 'rate_updated_at', 'lastUpdated', 'last_updated', '价格更新时间', '价格更新日期', '报价更新时间', '库存更新时间', '数据更新时间', '抓取时间', '同步时间', '更新时间', '更新日期'],
